	...
	public partial class UnoSamples_Tests : SampleControlUITestBase
	{
		...
		public void ScrollViewer_Margin()
		{
			...
			for (byte i = 1; i <= 5; i++)
			{
				...
				ImageAssert.HasColorAt(screenshot, physicalRect.Right - 23, physicalRect.Y + 22, Color.Red);
				// Middle
				...
				ImageAssert.HasColorAt(screenshot, physicalRect.X + 22, physicalRect.Bottom - 23, Color.Red);
				// Right / Bottom
				...
				ImageAssert.HasColorAt(screenshot, physicalRect.Right - 23, physicalRect.Bottom - 23, Color.Red);
		...
		public void ScrollViewer_Margin_Centered()
		{
			...
			for (byte i = 1; i <= 2; i++)
			{
				...
				ImageAssert.HasColorAt(screenshot, physicalRect.Right - 21, physicalRect.Y + 20, Color.Red);
				// Middle
				ImageAssert.HasColorAt(screenshot, physicalRect.CenterX, physicalRect.CenterY, Color.Red);
				// Left / Bottom
				ImageAssert.HasColorAt(screenshot, physicalRect.X + 10, physicalRect.Bottom - 11, Color.Orange);
				ImageAssert.HasColorAt(screenshot, physicalRect.X + 20, physicalRect.Bottom - 21, Color.Red);
				// Right / Bottom
				ImageAssert.HasColorAt(screenshot, physicalRect.Right - 11, physicalRect.Bottom - 11, Color.Orange);
				ImageAssert.HasColorAt(screenshot, physicalRect.Right - 21, physicalRect.Bottom - 21, Color.Red);
			}
		}
